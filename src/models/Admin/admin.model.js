...
const employeeCollectionSchema = Joi.object({
    ...
    salary: Joi.array().items(Joi.object()).default([]),
    ...
    soldOrderInYear: Joi.array().items(Joi.object()).default([]),
    workInMonth: Joi.array().items(Joi.object()).default([]),
    salaryInMonth: Joi.array().items(Joi.object()).default([]),
    salaryInYear: Joi.array().items(Joi.object()).default([]),
